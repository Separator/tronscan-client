...
describe('Wallet section', () => {
  test('Get the list of trx transfers related to a specific address', async () => {
  ...
  test('Get the transfer list of a specific TRC10 token for a certain address', async () => {
  ...
  test('Get the transfer list of a specific TRC20 token for a certain address', async () => {
